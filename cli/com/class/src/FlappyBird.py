# Welcome to my live coding / Q&A Session for October 20,2020
# If you have any Python questions - ask in chat
# Programming Editor: Smit

# Live coding May 20,2020 (Smit Anghan)
...
wn = turtle.Screen()
wn.title("Flappy Bird by @technicalsmit")
wn.bgcolor("red")
...
pipe3_top.speed(0)
pipe3_top.penup()
pipe3_top.color("blue")
pipe3_top.shape("circle")
